...
PARAMETERS: p_datat TYPE lvc_s_fcat-datatype default 'CHAR'.
...
START-OF-SELECTION.
  ...
  DATA(fcat) = VALUE lvc_t_fcat(
                                 ( fieldname = 'CARRID' )
                                 ( fieldname = 'CONNID' datatype = p_datat )
                                 ( fieldname = 'COUNTRYFR' )
                                 ( fieldname = 'CITYFROM' )
                                 ( fieldname = 'AIRPFROM' )
                                 ( fieldname = 'COUNTRYTO' )
                                 ( fieldname = 'CITYTO' )
                                 ( fieldname = 'FLTIME'   datatype = p_datat )
                                 ( fieldname = 'DEPTIME' datatype = p_datat )
                                 ( fieldname = 'FLTYPE' )
                               ).
